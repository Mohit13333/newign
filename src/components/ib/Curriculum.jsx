    ...
    <div className="py-5 overflow-hidden fade-in-section"
      ...
      <div className="container fade-in-section"
        ...
        <div className="curriculumSubSection" style={{ padding: '30px 0', marginBottom: '3rem' }}>
            <div className="SubHeading testSubheading">STAGES OF THE CURRICULUM
</div>
          ...
          >
           STAGES OF INTERNATIONAL BACCALAUREATE
SUPPORTED BY <span className="highlight">BY IGNITE</span>
          </h2>
        </div>
        </div>
      </div>
          ...
          <div className="card1 card-myp fade-in-section"
            ...
            <div>
              <div className="card-title2 card-title-myp">
                ...
                BACCALAUREATE<br />
                TUTORS FOR<br />
                <span className="program1" style={{
                  backgroundImage: 'linear-gradient(to right, #00A491, #003E37)',
